import 'package:daisy_application/pages/foundation/flow_controller.dart';
...
abstract class LifecycleAwareState<T extends StatefulWidget> extends State<T>
  ...
  FlowControllerState _flowController() =>
      context.findAncestorStateOfType<FlowControllerState>()!;
}
