...
class _RequestRestApi implements RequestRestApi {
  ...
  @override
  Future<HttpResponse<void>> createNewRequest(body) async {
  ...
  @override
  Future<HttpResponse<List<RequestModel>>> getAll() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<List<RequestModel>>> getAppliedRequest() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
